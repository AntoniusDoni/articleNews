...
class HomeScreen extends Component {
  ...
  getNewsApi = async () => {
    ...
    try {
      const response = await Axios.get('https://newsapi.org/v2/everything?domains=bbc.co.uk&from='+CurrentDate+'&to='+CurrentDate+'&page=1&sortBy=popularity&apiKey=541617d4c68b46b89d9c7a2facac5cd0')
      // console.log(response);
      this.setState({ isError: false, isLoading: false, data: response.data.articles })
